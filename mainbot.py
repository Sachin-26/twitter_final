...
while True:
    user = api.get_user('SachinShenoy14')
    api.update_profile(name=f'SACHIN|{follower_count(user)} Followers')
    print(f'Updating Twitter Name : SACHIN|{follower_count(user)} Followers')
